...
# joystick - 2 axis, 8 button.
mkdir -p functions/hid.usb2
echo 0 > functions/hid.usb2/protocol
echo 0 > functions/hid.usb2/subclass
echo 3 > functions/hid.usb2/report_length
echo -ne \\x05\\x01\\x09\\x04\\xa1\\x01\\x15\\x81\\x25\\x7f\\x09\\x01\\xa1\\x00\\x09\\x30\\x09\\x31\\x75\\x08\\x95\\x02\\x81\\x02\\xc0\\x05\\x09\\x19\\x01\\x29\\x08\\x15\\x00\\x25\\x01\\x75\\x01\\x95\\x08\\x81\\x02\\xc0 > functions/hid.usb0/report_desc
